...
class MyPlayerController(Entity):
    def __init__(self, **kwargs):
        ...
        # Crouch
        self.camera_y = self.height + 1.5
        self.crouch_height = self.camera_y - 0.5
    ...
    def crouch(self):
        self.height = lerp(self.height, self.crouch_height, self.crouch_speed * time.dt)

    # Sprint
    def input_sprint(self, key):
        if key == ['shift']:
            self.sprint_speed
        else:
